...
<!-- Navbar End -->
            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">SR KG</h1>
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">SR KG </h4>
                    <h1 class="mb-5 display-3">Exploring Big Ideas in Senior Kindergarten</h1>
                </div>
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-8 wow fadeIn" data-wow-delay="0.1s"><br>
                        <h5><b>Welcome to Our Upper KG – 5 Years +</b></h5><br>
                        <p>Welcome to the pinnacle of early education at <b>Smart Kids</b>—our Upper KG program! At this stage, your 5-year-old is not just a student; they’re a confident explorer, ready to showcase their potential in an environment that nurtures curiosity, self-expression, and academic growth.</p>
                    
                        <h5>🌟 <b>Confident Expression of Potential:</b></h5>
                        <p>Upper KG is the stage where children shine and display their full range of potential. They are aware of the opportunities around them and eagerly embrace every chance for learning and self-expression.</p>
                    
                        <h5>📖 <b>Vocabulary Expansion Extravaganza:</b></h5>
                        <p>Prepare for a vocabulary expansion extravaganza! At this stage, children are exposed to a wider array of words, allowing them to express themselves with confidence and flair. Communication becomes a joyful journey of self-discovery.</p>
                    
                        <h5>➕ <b>Math Marvels:</b></h5>
                        <p>In our Upper KG program, we delve into the world of mathematics with simple addition and subtraction. Your child will not only grasp these foundational concepts but will also embark on a colorful journey of discovering primary colors and their combinations to form magical secondary colors.</p>
                    
                        <h5>🧩 <b>Logical Reasoning Playground:</b></h5>
                        <p>Watch as logical reasoning comes to life through the excitement of solving simple puzzles. Our program stimulates cognitive development, allowing children to explore the fascinating world of patterns and logical thinking.</p>
                    
                        <h5>🎶 <b>Rhyme and Read Adventures:</b></h5>
                        <p>Reading takes on a rhythmic twist as children explore the world of rhyming words. Our approach to reading is not just about decoding letters but creating a harmonious symphony of language, making reading an enjoyable and enriching experience.</p>
                    
                        <h5>🌍 <b>Beyond the Classroom:</b></h5>
                        <p>Learning extends beyond the school walls with exciting field trips that enable children to explore their environment to the fullest. These real-world experiences enhance their understanding and bring lessons to life.</p>
                    
                        <p>Join us at <b>Smart Kids</b>, where education is an adventure, and every child is celebrated as a confident explorer. Our Upper KG program is not just a curriculum; it’s a showcase of potential, a celebration of language, math, and logical prowess. Together, let’s create a foundation for success and a future where your child can truly thrive!</p>
                    </div>
    <style>
    .program-img img {
        height: 300px;
        object-fit: cover;
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="program-item rounded">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/sr1.jpeg" class="img-fluid w-100" alt="Image 1">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/sr2.jpeg" class="img-fluid w-100" alt="Image 2">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/sr3.jpeg" class="img-fluid w-100" alt="Image 3">
                                </div> 
                            </div>            
                        </div>
                    </div>
