...
<!-- Navbar End -->
            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">Our Mission and vision</h1>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                        <div class="video border">
                            <button type="button" class="btn btn-play" data-bs-toggle="modal" data-src="img/vision.mp4" data-bs-target="#videoModal">
                                <span></span>
                            </button>
                        </div>
                    </div>
                    <div class="col-lg-7 wow fadeIn" data-wow-delay="0.3s">
                        <h1 class="text-dark mb-4 display-5">Building Bright Futures Through Smart Learning</h1>
                        <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">Our Mission: Commitment to Holistic Child-Centered Education</h4>
                        <p class="text-dark mb-4">
                            To realize our vision, Smart Kids schools are unwaveringly committed to:
                        </p>
                        <p class="text-dark mb-4">
                            ...
                            7) Holistic Educational Philosophy
                            8) Home-School Partnership
                            9) Respect for Diversity
                           10) Focus of the Month Program
                        </p>

                        <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">Our Vision: Shaping Future Leaders with Confidence and Compassion</h4>
                        <p class="text-dark mb-4">
                              At Smartkids, we envision leading the way as a distinguished preschool chain, dedicated to providing outstanding education. Our focus is on unlocking the unique potentials within each child and transforming them into young adults well-equipped to confidently navigate life’s challenges.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <script>
            // Ensure video only loads once when modal is opened
            var videoModal = document.getElementById('videoModal');
            videoModal.addEventListener('show.bs.modal', function (event) {
                var button = event.relatedTarget; // Button that triggered the modal
                var videoSrc = button.getAttribute('data-src'); // Get the video source
                var modalVideo = document.getElementById('video');
        
                // Set the iframe source only when the modal is shown
