...
<!-- Navbar End -->
            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">Nursery</h1>
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">Nursery </h4>
                    <h1 class="mb-5 display-3">Shaping Bright Futures, One Step at a Time</h1>
                </div>
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-8 wow fadeIn" data-wow-delay="0.1s"><br>
                        <h5><b>Welcome to Our Nursery – 3 Years +</b></h5><br>
                        <p>Step into the enchanting world of <b>SMART Kids</b>, where our Nursery program is not just a curriculum—it’s a captivating journey of exploration, imagination, and hands-on learning! We’ve redefined early education, setting the stage for a magical experience that transcends traditional teaching methods.</p>
                    
                        <h5>🔍 <b>Inquiry and Hands-On Teaching:</b></h5>
                        <p>Our Nursery program is built on the foundation of inquiry-based learning and hands-on teaching. Imagine your little ones actively engaging in the learning process, asking questions, and discovering the wonders of the world around them through exciting, interactive activities. It’s not just education; it’s a curiosity-fueled adventure!</p>
                    
                        <h5>🎨 <b>Individualized Instructions:</b></h5>
                        <p>Every child is unique, and we celebrate that individuality in our Nursery program. Our dedicated instructors tailor their teaching to meet the specific needs of each child, ensuring personalized learning experiences that foster growth and development.</p>
                    
                        <h5>🏙️ <b>Playful Interactions in the “City of Alphabet”:</b></h5>
                        <p>Welcome to the imaginary “City of Alphabet”—a whimsical world where letters come to life! In this creative space, letters interact, forming the building blocks of language. Through playful methods, children learn the sounds made by letters, unlocking the magical ability to form words and create enchanting stories.</p>
                    
                        <h5>💡 <b>Imaginative Skill Development:</b></h5>
                        <p>At <b>Smart Kids</b>, we don’t just teach; we ignite imagination! Our activities are designed to nurture imaginative skills in every child. From identifying numbers and letters to mastering the correct usage of action words, each moment is an opportunity for creative exploration.</p>
                    
                        <h5>📚 <b>Vocabulary Development Extravaganza:</b></h5>
                        <p>Prepare for a vocabulary development extravaganza! Our program goes beyond rote learning, encouraging language growth through dynamic and engaging activities. Your child will embark on a linguistic adventure, expanding their vocabulary in the most delightful ways.</p>
        ...
        object-fit: cover;
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="program-item rounded">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/nur1.jpeg" class="img-fluid w-100" alt="Image 1">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/nur2.jpeg" class="img-fluid w-100" alt="Image 2">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/nur3.jpeg" class="img-fluid w-100" alt="Image 3">
                                </div> 
                            </div>            
                        </div>
                    </div>
