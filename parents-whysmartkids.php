            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">Why Smartkids</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">Why Smartkids</h4>
                    <h1 class="mb-5 display-3">Little Stars, Big Dreams</h1>
                </div>
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-8 wow fadeIn" data-wow-delay="0.1s"><br>
                        <h4 class="text-left">What Makes Our Preschool Special:</h4><br>
                        <p>At Smartkids, our program focuses on hands-on learning that helps children grow in every way. We believe in nurturing values and bringing out the best in each child. Our approach supports development in thinking, emotions, and physical skills to help children become well-rounded and confident.</p>
                        <h5>🌈 Key Features:</h5>
                        <h6>🌈 Trusted Learning Programs</h6>
                        <p>Our Montessori, Nursery, and hands-on learning programs are designed to support your child’s overall development.</p>
                        <h6>🌈 Bright and Fun Classrooms</h6>
                        <p>Our classrooms are colorful, lively, and child-friendly to inspire creativity and learning.</p>
                        <h6>🌈 Learning Through Play</h6>
                        <p>We use engaging play-based methods that make learning fun and memorable.</p>
                        <h6>🌈 Parent Partnership</h6>
                        <p>We work closely with parents to create a special learning experience for each child.</p>
                        <h6>🌈 Parenting Support</h6>
                        <p>Our trained staff ensures your child’s safety and comfort every day.</p>
                        <h6>🌈 Celebrating Special Moments</h6>
                        <p>We make birthdays, festivals, and special days memorable for each child.</p>
                        <h6>🌈 Caring Staff</h6>
                        <p>We provide regular tips and guidance to help you support your child’s growth at home.</p>
                        <h6>🌈 Friendly and Skilled Teachers</h6>
                        <p>Our teachers are experienced, approachable, and committed to helping your child learn and grow.</p>
                        <h6>🌈 Safe and Clean Environment</h6>
                        <p>We provide a secure and hygienic space with regular health check-ups.</p>
                        <h6>🌈 Exciting Activity Areas</h6>
                        <p>Our activity rooms, audio-visual spaces, and role-play zones enrich your child’s learning experience.</p>
        ...
        object-fit: cover;
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="program-item rounded">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/why1.jpeg" class="img-fluid w-100" alt="Image 1">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/why2.jpeg" class="img-fluid w-100" alt="Image 2">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/why3.jpeg" class="img-fluid w-100" alt="Image 3">
                                </div> 
                            </div>            
                        </div>
                    </div>
