            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">Activities at SmartKids</h1>
...
<!-- Service End -->
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">Activities at Smartkids </h4>
                    <h1 class="mb-5 display-3">Fun with Numbers & Letters</h1>
                </div>
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-8 wow fadeIn" data-wow-delay="0.1s"><br>

                        <h5><b>About Our Activities at Smart Kids:</b></h5><br>
                        <p>At <b>Smart Kids</b>, we offer a dynamic range of activities that focus on engaging children through exploration, learning, and safety. Our activities are crafted to enhance cognitive, emotional, and physical development in a secure and welcoming environment, allowing children to grow and explore confidently.</p>
                        
                        <h5>🌈 <b>Engaging Classrooms</b></h5>
                        <p>Our classrooms are not just spaces for learning but vibrant environments filled with interactive displays, educational tools, and comfortable furniture. Each space is thoughtfully designed to capture children's attention and foster a love for learning through visually stimulating elements and hands-on activities.</p>
                    
                        <h5>🌈 <b>Creative Activity Area</b></h5>
                        <p>The Activity Area is where learning meets play. Here, children enjoy immersive role-playing in areas like the Doll House and Farm House, enhancing their social skills and imagination. Activities like painting, storytelling, and our fun “Tuck Shop” concept help build creativity and problem-solving skills in a playful, hands-on manner.</p>
                    
                        <h5>🌈 <b>Multimedia Learning</b></h5>
                        <p>In our Audio Visual Rooms, learning comes to life with state-of-the-art technology. Equipped with interactive projectors, large screens, and educational software, we offer children a chance to engage with content in an exciting and dynamic way, supporting visual and auditory learning styles.</p>
                    
                        <h5>🌈 <b>Celebration Zone</b></h5>
                        <p>At Smart Kids, every occasion is a celebration! Our Celebration Area is perfect for hosting birthday parties, festivals, and special events, where children can actively participate and enjoy music, dance, and performances. These moments help build a sense of community, excitement, and belonging.</p>
                    
                        <h5>🌈 <b>Interactive Play Area</b></h5>
                        <p>Our Play Area is designed to foster physical, mental, and emotional growth. Children have fun while improving their motor skills through activities like swinging, climbing, and playing on slides. Special performances like magic shows and puppet theaters bring an extra touch of joy to the playtime experience, keeping children engaged and entertained.</p>
                    
                        <h5>🌈 <b>Inclusive Learning Environment</b></h5>
                        <p>We believe in making learning accessible for every child. Our activities cater to a variety of learning styles and needs, ensuring that all children, regardless of ability, feel included and supported. By encouraging collaboration, respect, and kindness, we create an environment that celebrates diversity and fosters social-emotional growth.</p>
                    
                        <h5>🌈 <b>Join Smart Kids!</b></h5>
        ...
        object-fit: cover;
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="program-item rounded">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/act1.jpeg" class="img-fluid w-100" alt="Image 1">
                                </div> 
                            </div>            
                        </div>
                        <br>
                        ...
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/act2.jpeg" class="img-fluid w-100" alt="Image 2">
                                </div> 
                            </div>            
                        </div>
                        <br>
                        ...
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/act3.jpeg" class="img-fluid w-100" alt="Image 2">
                                </div> 
                            </div>            
                        </div>
                    </div>
