    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-7 col-md-12">
                <h1 class="mb-5 display-1 text-white">The Perfect Place for Little Ones</h1>
                <br>
                <br>    
...
<!-- Hero End -->
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <p class="text-dark mb-4">Welcome to Smart Kids Play School, a joyful learning space in Bhimavaram where little stars shine bright! We focus on nurturing young minds through fun, creativity, and interactive learning.
                        At Smart Kids, we provide a safe, engaging, and child-friendly environment where kids explore, learn, and grow with play-based activities. Our dedicated teachers ensure that every child receives personal attention to build confidence and essential skills.
                        Join us in making the first step of learning exciting and memorable for your little one!
                        </p>
                        <div class="row mb-4">
                            <div class="col-lg-6">
            ...
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        ...
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/gyACVzS21i0?si=1yLoRTAvvySN9Kj_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        ...
        <script>
    // Reset video when the modal is closed
    var videoModal = document.getElementById('videoModal');
    videoModal.addEventListener('hidden.bs.modal', function () {
        var modalVideo = document.querySelector('#videoModal iframe');
        modalVideo.src = modalVideo.src; // This will stop the video by reloading the iframe
    });
</script>
...
<!-- Testimonial Start -->
    ...
    .video-container {
        ...
        width: 100%;
        height: 200px;
        background: url('img/testimonial.jpg') center/cover no-repeat; /* Add thumbnail */
    }
    ...
    .video-container video.playing + .play-button {
        display: none; /* Hide play button when video starts */
    }
</style>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const videos = document.querySelectorAll(".testimonial-item video");
                ...
                <div class="p-4 position-relative">
                    <div class="border-top border-primary mt-4 pt-3">
                        <div class="video-container">
                            <video>
                                <source src="img/testimonial1.mp4" type="video/mp4">
            ...
            <div class="testimonial-item img-border-radius bg-light border border-primary p-4">
                <div class="p-4 position-relative">
                    <div class="border-top border-primary mt-4 pt-3">
                        <div class="video-container">
                            <video>
                                <source src="img/testimonial2.mp4" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                            <div class="play-button"></div>
                        </div>
            ...
            <div class="testimonial-item img-border-radius bg-light border border-primary p-4">
                <div class="p-4 position-relative">
                    <div class="border-top border-primary mt-4 pt-3">
                        <div class="video-container">
                            <video>
                                <source src="img/testimonial3.mp4" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                            <div class="play-button"></div>
                        </div>
