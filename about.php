            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">About US</h1>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <h1 class="text-dark mb-4 display-5">Building a Bright Future for Your Child Through Smart Learning.</h1>
                        <p class="text-dark mb-4">Welcome to <b>Smart Kids Play School</b>, a joyful learning space in Bhimavaram where little stars shine bright! We focus on nurturing young minds through fun, creativity, and interactive learning. At Smart Kids, we provide a safe, engaging, and child-friendly environment where kids explore, learn, and grow with play-based activities. Our dedicated teachers ensure that every child receives personal attention to build confidence and essential skills. Join us in making the first step of learning exciting and memorable for your little one!
                        </p>
                        <div class="row mb-4">
                            <div class="col-lg-6">
