            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">Admission Information</h1>
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">Admission</h4>
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-8 wow fadeIn" data-wow-delay="0.1s">
                        <h4 class="text-left"><br>
                            Admissions at SMARTKIDS</h4><br>
                        <p>At SMARTKIDS, we believe that every child deserves a nurturing and stimulating learning environment where they can grow, explore, and thrive. Our admissions process is designed to be simple and transparent, ensuring that parents can easily enroll their little ones into a world of joyful learning.</p>
                        <h5>🌟 Why Choose SMARTKIDS?</h5><br>
                        <h6>✔️ Child-Centered Curriculum</h6><br>
                        <h6>✔️ Safe & Engaging Environment</h6><br>
                        <h6>✔️ Experienced & Caring Educators</h6><br>
                        <h6>✔️ Holistic Development Approach</h6><br>
                        <h6>✔️ Strong Parent-School Partnership</h6><br>
                        <h5>🌈 Admission Process</h5><br>
                        <h6>🌈 Inquiry & Shool Visit</h6>
                        <p>We invite parents to visit our school to explore our vibrant classrooms, play areas, and learning zones. Our team will be happy to answer any questions and provide insights into our curriculum and daily routines.</p>
                        <h6>🌈 Registration Form Submission</h6>
                        <p>Parents can collect the admission form from our front desk. The completed form, along with necessary documents, must be submitted for further processing.</p>
                        <h6>🌈 Interaction Session</h6>
                        <p>To understand each child's needs and ensure a smooth transition, we conduct an informal interaction session. This helps us create a personalized learning experience for every child.</p>
                        <h6>🌈 Confirmation & Fee Payment</h6>
                        <p>Once admission is confirmed, parents will receive an official confirmation letter. The next step involves completing the fee payment to secure the child’s seat.</p>
                        <h6>🌈 Welcome to SMARTKIDS!</h6>
                        <p>After enrollment, parents receive a welcome kit with essential details, including uniform guidelines, school policies, and academic schedules. Our team ensures a warm and smooth onboarding experience for every child.</p>
