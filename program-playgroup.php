...
<!-- Navbar End -->
            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">Play Group</h1>
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">Play Group </h4>
                    <h1 class="mb-5 display-3">The Joyful Start to Big Adventures</h1>
                </div>
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-8 wow fadeIn" data-wow-delay="0.1s"><br>
                        <h5><b>Welcome to Our Playgroup</b></h5><br>
                        <p>A vibrant and nurturing environment designed for children aged 2 years and above, where we seamlessly blend the warmth of home with the excitement of early education! We understand that the first day of school can be emotional for both parents and children, and we've crafted a welcoming space to make everyone feel right at home from the very beginning.</p>
                    
                        <h5>🏠 <b>A Home Away from Home:</b></h5>
                        <p>Our playgroup is more than just a school; it’s an extension of your child’s home. We’ve created a cozy, inviting atmosphere to ease the transition from family life to the excitement of early education. Here, children feel secure, valued, and ready to explore the world around them.</p>
                    
                        <h5>🎉 <b>Engaging Activities for Little Minds:</b></h5>
                        <p>Learning is all about play! Our playgroup activities are designed to improve coordination and introduce the basics of letters and numbers through engaging, play-based methods. Imagine your child joyfully singing along as they naturally learn numbers 1-20 and the alphabet from A to Z.</p>
                    
                        <h5>🗣 <b>Language Enrichment:</b></h5>
                        <p>Communication is essential, and we focus on language development. Children engage in activities that encourage proper use of action words and vocabulary building, laying a strong foundation for effective communication and curiosity-driven learning.</p>
                    
                        <h5>🚽 <b>Toilet Training Made Fun:</b></h5>
                        <p>We understand that toilet training is a big milestone, and we make it a gradual, enjoyable process. With designated recess times and a supportive approach, we guide your child through this essential skill in a way that feels positive and pressure-free.</p>
                    
                        <h5>🤝 <b>Parent Involvement:</b></h5>
                        <p>We believe in the power of collaboration. Parents are a crucial part of our playgroup journey, and we invite you to be actively involved in your child’s learning experiences. Every milestone becomes a shared celebration, building a strong foundation for growth.</p>
        ...
        object-fit: cover;
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="program-item rounded">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/play1.jpeg" class="img-fluid w-100" alt="Image 1">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/play2.jpeg" class="img-fluid w-100" alt="Image 2">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
