...
<!-- Navbar End -->
            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">Smartkids Curriculum</h1>
    ...
    <!-- Service End -->
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">Smartkids curriculum</h4>
                    <h1 class="mb-5 display-3">Building Foundations for Bright Futures</h1>
                </div>
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-8 wow fadeIn" data-wow-delay="0.1s"><br><br>
                        <h5><b>About Our Curriculum:</b></h5><br>
                        <p>Welcome to <b>Smart Kids</b>, where education becomes a transformative journey. Our curriculum is uniquely crafted to foster experiential learning, instilling values and uncovering each child’s unique potential. Through a focus on holistic development, we create an environment that supports cognitive, emotional, social, and physical growth, preparing every child for a successful and fulfilling future.</p>
                    
                        <br><h5>🌈 <b>Key Features of Our Curriculum:</b></h5><br>
                    
                        <h6>🌈 <b>Experiential Learning Focus:</b></h6>
                        <p>Our curriculum celebrates experiential learning by allowing children to be active participants in their educational journey. Engaging hands-on experiences enable children to grasp complex concepts effortlessly while building essential life skills such as problem-solving, teamwork, and adaptability. This approach enriches their learning process and builds confidence, fostering a lifelong love for learning.</p>
                    
                        <h6>🌈 <b>Building Virtues and Character:</b></h6>
                        <p>At <b>Smart Kids</b>, we go beyond traditional education by prioritizing character development. Our curriculum nurtures core values like kindness, empathy, resilience, and integrity. We believe education should not only shape knowledgeable individuals but also mold compassionate and responsible citizens who positively impact society.</p>
                    
                        <h6>🌈 <b>Holistic Development for Every Child:</b></h6>
                        <p>Our curriculum emphasizes a well-rounded approach to growth, including cognitive, emotional, and physical development. We recognize that every child is unique, and we aim to cultivate their strengths while addressing their individual needs. Our programs integrate physical activities, emotional literacy, and cognitive challenges, ensuring that children develop into balanced and capable individuals.</p>
                    
                        <h6>🌈 <b>Innovative Teaching Techniques:</b></h6>
                        <p>We use innovative teaching methods that combine the best of traditional and modern approaches. Our educators are trained to facilitate an engaging, inclusive learning environment where creativity is encouraged, and curiosity is celebrated. Interactive projects, group discussions, and digital tools enhance the learning experience, making it relevant and exciting for today’s young minds.</p>
                    
                        <p>Join us at <b>Smart Kids</b> to embark on an extraordinary educational journey where experiential learning illuminates the path to success, values form the foundation of character, and every child’s unique potential is celebrated and nurtured.</p>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="program-item rounded">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/cur1.jpeg" class="img-fluid w-100" alt="Image 1">
                                </div> 
                            </div>            
                        </div><br>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/cur2.jpeg" class="img-fluid w-100" alt="Image 2">
                                </div> 
                            </div>            
                        </div><br>
                        <div class="program-item rounded" style="margin-top: 20px;">                                            
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/cur3.jpeg" class="img-fluid w-100" alt="Image 3">
                                </div> 
                            </div>            
                        </div>
                    </div>
