            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">JR KG</h1>
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">JR KG</h4>
                    <h1 class="mb-5 display-3">The Joyful Journey of Junior Kindergarten</h1>
                </div>
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-8 wow fadeIn" data-wow-delay="0.1s"><br>
                        <h5><b>Welcome to Our Lower KG – 4 Years +</b></h5><br>
                        <p>Welcome to <b>Smart Kids</b>, where our Lower KG program is not just a step forward; it’s a leap into a world of boundless potential and holistic education! We understand that 4-year-olds are ready to blossom, and our LKG program is designed to nurture their emerging abilities in a stimulating and engaging environment.</p>
                    
                        <h5>🌟 <b>Solid Foundations for Lifelong Learning:</b></h5>
                        <p>In our LKG program, we build upon the solid foundations laid in earlier stages, setting the stage for a well-rounded education. Your child’s potential is not just acknowledged; it’s celebrated as we embark on a journey of discovery and growth.</p>
                    
                        <h5>📚 <b>Vibrant Vocabulary Enhancement:</b></h5>
                        <p>Every day is a word-filled adventure! We prioritize vocabulary development, ensuring that your child’s speaking skills flourish. Through interactive and engaging activities, we create an environment where words come alive, laying the groundwork for effective communication.</p>
                    
                        <h5>🔤 <b>Alphabet Adventures with Phonics:</b></h5>
                        <p>Reading and writing take center stage as we embark on alphabet adventures with the magic of phonics. Letters become friends, and your child will joyfully explore the world of language, unlocking the power to read and write with confidence.</p>
                    
                        <h5>🔢 <b>Math Magic Extravaganza:</b></h5>
                        <p>Get ready for a Math magic extravaganza! Our comprehensive Maths curriculum covers counting, figure identification, sizes and measurements, shapes, colors, patterns, numbering, counting, sorting, and classifying. Your child will not just learn numbers; they’ll dance with them!</p>
                    
                        <h5>🎨 <b>Beyond the Classroom:</b></h5>
                        <p>Our LKG program extends beyond traditional subjects, introducing your child to the wonders of science, unleashing creativity through the arts, and creating harmony through the magic of music. All of this takes place in a relaxed and conducive atmosphere, where learning is a joyous adventure.</p>
        ...
        object-fit: cover;
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="program-item rounded">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/jr1.jpeg" class="img-fluid w-100" alt="Image 1">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/jr2.jpeg" class="img-fluid w-100" alt="Image 2">
                                </div> 
                            </div>            
                        </div>
                        <div class="program-item rounded" style="margin-top: 20px;">
                            <div class="program-img position-relative">
                                <div class="overflow-hidden img-border-radius">
                                    <img src="img/jr3.jpeg" class="img-fluid w-100" alt="Image 3">
                                </div> 
                            </div>            
                        </div>
                    </div>
