            ...
            <div class="container py-5">
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-7 col-md-12 text-center">
                        <h1 class="mb-5 display-1 text-white">Parents as partners</h1>
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">Parents as Partners</h4>
                    <h1 class="mb-5 display-3">Collaborating for Your Child's Success</h1>
                </div>
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-8 wow fadeIn" data-wow-delay="0.1s"><br>
                        <h4 class="text-left">Our Partnership with Parents:</h4><br>
                        <p>At Smartkids, we believe in a close partnership with parents to support each child’s growth and success. We keep parents involved through regular updates, workshops, and family-friendly events, creating a strong connection between home and school. By working together, we help children develop confidence, curiosity, and a love for learning that thrives both inside and outside the classroom.</p>
                        <h5>🌈 Key Features:</h5>
                        <h6>🌈 Collaborative Learning Journey</h6>
                        <p>We believe in building a strong partnership with parents, working together to nurture each child's growth and development.</p>
                        <h6>🌈 Open Communication</h6>
                        <p>Regular updates and open channels ensure parents stay informed about their child's progress and milestones.</p>
                        <h6>🌈 Parental Involvement Programs</h6>
                        <p>Engaging parents in classroom activities, events, and special programs that strengthen the bond between home and school.</p>
                        <h6>🌈 Parent-Teacher Meetings</h6>
                        <p>Scheduled meetings to discuss each child’s progress, address concerns, and create personalized plans for their growth.</p>
                        <h6>🌈 Personalized Parenting Tips</h6>
                        <p>Sharing regular, personalized tips to help parents nurture their child's potential outside the classroom.</p>
                        <h6>🌈 Feedback and Suggestions</h6>
                        <p> We value parent feedback and suggestions, using them to enhance our curriculum and create a more enriching experience for every child.</p>
                        <h6>🌈 Support for Parenting Challenges</h6>
                        <p>Providing resources and guidance to address common parenting challenges, from setting routines to managing emotions.</p>
                        <h6>🌈 Home Connection Activities</h6>
                        <p>Offering fun, at-home activities that parents and children can enjoy together to reinforce classroom learning.</p>
                        <h6>🌈 Parent Orientation Programs</h6>
                        <p>Welcoming new families with orientation sessions that provide insights into our preschool’s philosophy, curriculum, and daily routines.</p>
                        <h6>🌈 Child Development Insights</h6>
                        <p>Providing regular updates on child development topics, such as social-emotional skills, early literacy, and positive discipline, to support parenting at home.</p>
